...
public class ThreeCoralL4LeftRed extends SequentialCommandGroup {
  /** Creates a new ThreeCoralL4Left. */
  public ThreeCoralL4LeftRed(DriveTrain driveTrain, Elevator elevator, CoralAffector coralAffector) {
    ...
    addCommands(new SetInitialPose(driveTrain, AutonConstants.initialPoseRedLeft),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.backLeft).withReefAlignment(Alignment.left, true)),
                ...
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.frontLeft).withReefAlignment(Alignment.left, true)),
                                         new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.L4)),
                new AutonCoralScore(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, coralStation.withRobotRelativeTransformation(
                                                                                  new Translation2d(AutoAimConstants.coralStationSideOffsetDistance,
                                         ...
                                         new SequentialCommandGroup(new Wait(AutonConstants.awayFromReefTime), 
                                                                    ...
                                                                    new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.HP))),
                new AutonCoralCollect(coralAffector), 
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.frontLeft).withReefAlignment(Alignment.right, true)),
                                         new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.L4)),
                new AutonCoralScore(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, coralStation.withRobotRelativeTransformation(
                                                                                  new Translation2d(AutoAimConstants.coralStationSideOffsetDistance,
