...
public class BackAndScoreBlue extends SequentialCommandGroup {
  /** Creates a new BackAndScore. */
  public BackAndScoreBlue(DriveTrain driveTrain, Elevator elevator, CoralAffector coralAffector, Alignment coralAlignment) {
