...
public class ThreeCoralL4RightBlue extends SequentialCommandGroup {
  /** Creates a new ThreeCoralL4. */
  public ThreeCoralL4RightBlue(DriveTrain driveTrain, Elevator elevator, CoralAffector coralAffector) {
