...
public class FourCoralL3LeftRed extends SequentialCommandGroup {
  /** Creates a new FourCoralL3. */
  public FourCoralL3LeftRed(DriveTrain driveTrain, CoralAffector coralAffector, Elevator elevator) {
    //HashMap<ReefStation, AdvancedPose2D> reef = AutoAimConstants.redReef;
    AdvancedPose2D coralStation = AutoAimConstants.redLeftCoralStationPos;
    
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new SetInitialPose(driveTrain, AutonConstants.initialPoseRedLeft),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.backLeft).withReefAlignment(Alignment.left, false)),
                ...
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.backLeft).withReefAlignment(Alignment.right, false)),
                                         new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.L3)), 
                new AutonCoralScore(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, coralStation.withRobotRelativeTransformation(
                                                                                  new Translation2d(AutoAimConstants.coralStationSideOffsetDistance, 
                                         ...
                                         new SequentialCommandGroup(new AutonAllToPosition(elevator, coralAffector, driveTrain, Position.floor), 
                                                                    new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.HP))),
                new AutonCoralCollect(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.frontLeft).withReefAlignment(Alignment.left, false)),
                                         new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.L3)), 
                new AutonCoralScore(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, coralStation.withRobotRelativeTransformation(
                                                                                  new Translation2d(AutoAimConstants.coralStationSideOffsetDistance, 
                                         ...
                                         new SequentialCommandGroup(new AutonAllToPosition(elevator, coralAffector, driveTrain, Position.floor), 
                                                                    new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.HP))),
                new AutonCoralCollect(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, AutoAimConstants.redReef.get(ReefStation.frontLeft).withReefAlignment(Alignment.right, false)),
                                         new InRangeAllToPosition(elevator, coralAffector, driveTrain, Position.L3)),
                new AutonCoralScore(coralAffector),
                new ParallelCommandGroup(new AutonDriveToPosition(driveTrain, coralStation.withRobotRelativeTransformation(
                                                                                  new Translation2d(AutoAimConstants.coralStationSideOffsetDistance, 
