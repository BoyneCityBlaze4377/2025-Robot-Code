...
public class BackScoreAndLeft extends SequentialCommandGroup {
  /** Creates a new DriveOffLine. */
  public BackScoreAndLeft(DriveTrain driveTrain, AdvancedPose2D initialPose, Elevator elevator, CoralAffector coralAffector) {
