...
public class BackScoreAndRight extends SequentialCommandGroup {
  /** Creates a new DriveOffLine. */
  public BackScoreAndRight(DriveTrain driveTrain, AdvancedPose2D initialPose, Elevator elevator, CoralAffector coralAffector) {
    ...
    addCommands(new SetInitialPose(driveTrain, initialPose),
                ...
                new RawAutonDrive(driveTrain, 0, -1, 0, 1.5, 0));
  }
}
